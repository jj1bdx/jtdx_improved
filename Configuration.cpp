...
private:
  ...
  Q_SLOT void on_differentBackground_check_box_clicked(bool checked);
  Q_SLOT void on_cyan_check_box_clicked(bool checked);
  Q_SLOT void on_yellow_check_box_clicked(bool checked);
...
bool Configuration::alertOnMyCall () const {return m_->alertOnMyCall_;}
bool Configuration::alertOnNewCQZ () const {return m_->alertOnNewCQZ_;}
bool Configuration::alertOnNewITUZ () const {return m_->alertOnNewITUZ_;}
bool Configuration::alertOnNewDXCC () const {return m_->alertOnNewDXCC_;}
bool Configuration::alertOnNewGrid () const {return m_->alertOnNewGrid_;}
bool Configuration::alertOnNewPx () const {return m_->alertOnNewPx_;}
bool Configuration::alertOnNewCQZOB () const {return m_->alertOnNewCQZOB_;}
bool Configuration::alertOnNewITUZOB () const {return m_->alertOnNewITUZOB_;}
bool Configuration::alertOnNewDXCCOB () const {return m_->alertOnNewDXCCOB_;}
bool Configuration::alertOnNewGridOB () const {return m_->alertOnNewGridOB_;}
bool Configuration::alertOnNewPxOB () const {return m_->alertOnNewPxOB_;}
bool Configuration::alertOnDXCall () const {return m_->alertOnDXCall_;}
bool Configuration::highlightDXCall () const {return m_->highlightDXCall_;}
bool Configuration::highlightDXGrid () const {return m_->highlightDXGrid_;}
  ...
  , default_audio_output_device_selected_ {false}
{
  ...
  ui_->alert_on_newCQZ_check_box->setChecked(alertOnNewCQZ_);
  ui_->alert_on_newCQZOB_check_box->setChecked(alertOnNewCQZOB_);
  ui_->alert_on_newITUZ_check_box->setChecked(alertOnNewITUZ_);
  ui_->alert_on_newITUZOB_check_box->setChecked(alertOnNewITUZOB_);
  ui_->alert_on_newDXCC_check_box->setChecked(alertOnNewDXCC_);
  ui_->alert_on_newDXCCOB_check_box->setChecked(alertOnNewDXCCOB_);
  ui_->alert_on_newPx_check_box->setChecked(alertOnNewPx_);
  ui_->alert_on_newPxOB_check_box->setChecked(alertOnNewPxOB_);
  ui_->alert_on_newGrid_check_box->setChecked(alertOnNewGrid_);
  ui_->alert_on_newGridOB_check_box->setChecked(alertOnNewGridOB_);
  ui_->alert_on_my_call_check_box->setChecked(alertOnMyCall_);
  ui_->alert_on_DX_call_check_box->setChecked(alertOnDXCall_);
  ui_->highlightDXCall_check_box->setChecked(highlightDXCall_);
  ui_->highlightDXGrid_check_box->setChecked(highlightDXGrid_);
  if(content_.isEmpty ()) {
...
//check scheduler settings for consistency
  ...
  alertOnMyCall_ = settings_->value("AlertOnMyCall", false).toBool();
  alertOnNewCQZ_ = settings_->value("AlertOnNewCQZ", false).toBool();
  alertOnNewITUZ_ = settings_->value("AlertOnNewITUZ", false).toBool();
  alertOnNewDXCC_ = settings_->value("AlertOnNewDXCC", false).toBool();
  alertOnNewGrid_ = settings_->value("AlertOnNewGrid", false).toBool();
  alertOnNewPx_ = settings_->value("AlertOnNewPx", false).toBool();
  alertOnDXCall_ = settings_->value("AlertOnDXCall", false).toBool();
  highlightDXCall_ = settings_->value("highlightDXCall", false).toBool();
  highlightDXGrid_ = settings_->value("highlightDXGrid", false).toBool();
  alertOnNewCQZOB_ = settings_->value("AlertOnNewCQZOB", false).toBool();
  alertOnNewITUZOB_ = settings_->value("AlertOnNewITUZOB", false).toBool();
  alertOnNewDXCCOB_ = settings_->value("AlertOnNewDXCCOB", false).toBool();
  alertOnNewGridOB_ = settings_->value("AlertOnNewGridOB", false).toBool();
  alertOnNewPxOB_ = settings_->value("AlertOnNewPxOB", false).toBool();
...
void Configuration::impl::write_settings ()
{
  ...
  settings_->setValue ("AlertOnMyCall", alertOnMyCall_);
  settings_->setValue ("AlertOnNewCQZ", alertOnNewCQZ_);
  settings_->setValue ("AlertOnNewITUZ", alertOnNewITUZ_);
  settings_->setValue ("AlertOnNewDXCC", alertOnNewDXCC_);
  settings_->setValue ("AlertOnNewGrid", alertOnNewGrid_);
  settings_->setValue ("AlertOnNewPx", alertOnNewPx_);
  settings_->setValue ("AlertOnDXCall", alertOnDXCall_);
  settings_->setValue ("highlightDXCall", highlightDXCall_);
  settings_->setValue ("highlightDXGrid", highlightDXGrid_);
  settings_->setValue ("AlertOnNewCQZOB", alertOnNewCQZOB_);
  settings_->setValue ("AlertOnNewITUZOB", alertOnNewITUZOB_);
  settings_->setValue ("AlertOnNewDXCCOB", alertOnNewDXCCOB_);
  settings_->setValue ("AlertOnNewGridOB", alertOnNewGridOB_);
  settings_->setValue ("AlertOnNewPxOB", alertOnNewPxOB_);
...
void Configuration::impl::accept ()
{
  ...
  alertOnMyCall_ = ui_->alert_on_my_call_check_box->isChecked();
  alertOnNewCQZ_ = ui_->alert_on_newCQZ_check_box->isChecked();
  alertOnNewITUZ_ = ui_->alert_on_newITUZ_check_box->isChecked();
  alertOnNewDXCC_ = ui_->alert_on_newDXCC_check_box->isChecked();
  alertOnNewGrid_ = ui_->alert_on_newGrid_check_box->isChecked();
  alertOnNewPx_ = ui_->alert_on_newPx_check_box->isChecked();
  alertOnDXCall_ = ui_->alert_on_DX_call_check_box->isChecked();
  highlightDXCall_ = ui_->highlightDXCall_check_box->isChecked();
  highlightDXGrid_ = ui_->highlightDXGrid_check_box->isChecked();
  alertOnNewCQZOB_ = ui_->alert_on_newCQZOB_check_box->isChecked();
  alertOnNewITUZOB_ = ui_->alert_on_newITUZOB_check_box->isChecked();
  alertOnNewDXCCOB_ = ui_->alert_on_newDXCCOB_check_box->isChecked();
  alertOnNewGridOB_ = ui_->alert_on_newGridOB_check_box->isChecked();
  alertOnNewPxOB_ = ui_->alert_on_newPxOB_check_box->isChecked();
...
void Configuration::impl::on_differentBackground_check_box_clicked(bool checked)
{
  if(checked) {
      ui_->cyan_check_box->setEnabled(true);
      ui_->yellow_check_box->setEnabled(true);
  } else {
      ui_->cyan_check_box->setEnabled(false);
      ui_->yellow_check_box->setEnabled(false);
  }
}

void Configuration::impl::on_cyan_check_box_clicked(bool checked)
{
  if(checked) {
      ui_->cyan_check_box->setChecked(true);
      ui_->yellow_check_box->setChecked(false);
  }
}

void Configuration::impl::on_yellow_check_box_clicked(bool checked)
{
  if(checked) {
      ui_->cyan_check_box->setChecked(false);
      ui_->yellow_check_box->setChecked(true);
  }
}
