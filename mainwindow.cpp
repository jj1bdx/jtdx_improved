...
void MainWindow::writeSettings()
{
  ...
  m_settings->setValue("HideBandButtons",ui->actionBand_buttons->isChecked());
  ...
  m_settings->setValue ("bh_40mJT", ui->cb40mJT->isChecked() );
  m_settings->setValue ("bh_20mJT", ui->cb20mJT->isChecked() );
  m_settings->setValue ("bh_15mJT", ui->cb15mJT->isChecked() );
  m_settings->setValue ("bh_10mJT", ui->cb10mJT->isChecked() );
...
void MainWindow::readSettings()
{
  ...
  ui->cb40mJT->setChecked(m_settings->value("bh_40mJT", false).toBool());
  ui->cb20mJT->setChecked(m_settings->value("bh_20mJT", false).toBool());
  ui->cb15mJT->setChecked(m_settings->value("bh_15mJT", false).toBool());
  ui->cb10mJT->setChecked(m_settings->value("bh_10mJT", false).toBool());
  ...
  ui->actionBand_buttons->setChecked(m_settings->value("HideBandButtons",false).toBool());
...
void MainWindow::set_application_font (QFont const& font)
{
    ...
    if (pointSize < 9) {
        ui->rightControlsWidget->setMaximumWidth(180);
        ui->tabWidget->setMaximumHeight(210);
        ui->TxMinuteButton->setMinimumWidth(0);
        ui->SWRlabel->setMinimumWidth(0);
        ui->signal_meter_widget->setMaximumWidth(65);
    }
    if (pointSize == 9) {
        ui->rightControlsWidget->setMaximumWidth(200);
    ...
    if (pointSize == 10) {
        ui->rightControlsWidget->setMaximumWidth(220);
        ui->tabWidget->setMaximumHeight(230);
        ui->TxMinuteButton->setMinimumWidth(70);
        ui->SWRlabel->setMinimumWidth(45);
        ui->signal_meter_widget->setMaximumWidth(65);
    }
    if (pointSize == 11) {
        ui->rightControlsWidget->setMaximumWidth(240);
        ui->tabWidget->setMaximumHeight(250);
        ui->TxMinuteButton->setMinimumWidth(80);
        ui->SWRlabel->setMinimumWidth(55);
        ui->signal_meter_widget->setMaximumWidth(68);
    }
    if (pointSize == 12) {
        ui->rightControlsWidget->setMaximumWidth(250);
        ui->tabWidget->setMaximumHeight(260);
        ui->TxMinuteButton->setMinimumWidth(80);
        ui->SWRlabel->setMinimumWidth(60);
        ui->signal_meter_widget->setMaximumWidth(72);
    }
    if (pointSize > 12) {
        ui->rightControlsWidget->setMaximumWidth(270);
        ui->tabWidget->setMaximumHeight(280);
        ui->TxMinuteButton->setMinimumWidth(100);
        ui->SWRlabel->setMinimumWidth(65);
        ui->signal_meter_widget->setMaximumWidth(75);
    }
//    styleChanged(); likely not necessary
}
  ...
  if(m_start || reset) {
    if(m_mode.startsWith("FT")) {
      if(m_mode=="FT8") {
        ...
        if((isecond >= 0 &&  isecond < 15) || (isecond >= 30 &&  isecond < 45)) ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color : %2").arg(Radio::convert_dark("#96ffff",m_useDarkStyle),Radio::convert_dark("#1400b1",m_useDarkStyle)));
        else ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
      }
      else if(m_mode=="FT4") {
        if(ft4int==0 || ft4int==2 || ft4int==4 || ft4int==6) ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color : %2").arg(Radio::convert_dark("#96ffff",m_useDarkStyle),Radio::convert_dark("#1400b1",m_useDarkStyle)));
        else ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
      }
    }
    else if(!m_mode.startsWith ("WSPR")) {
      if((minute.toInt())%2==0)	ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color : %2").arg(Radio::convert_dark("#96ffff",m_useDarkStyle),Radio::convert_dark("#1400b1",m_useDarkStyle)));
      else ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
    }

    if(m_mode.startsWith ("WSPR")) {
      ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
    ...
    if(m_mode=="FT8") {
      if(second=="00" || second=="30") ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color : %2").arg(Radio::convert_dark("#96ffff",m_useDarkStyle),Radio::convert_dark("#1400b1",m_useDarkStyle)));
      else if(second=="15" || second=="45") ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
	}
    else if(m_mode=="FT4") {
        if(ft4int==0 || ft4int==2 || ft4int==4 || ft4int==6) ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color : %2").arg(Radio::convert_dark("#96ffff",m_useDarkStyle),Radio::convert_dark("#1400b1",m_useDarkStyle)));
        else ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
		...
		if((minute.toInt())%2==0) {
            ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color : %2").arg(Radio::convert_dark("#96ffff",m_useDarkStyle),Radio::convert_dark("#1400b1",m_useDarkStyle)));
        } else {
            ui->labUTC->setStyleSheet(QString("font-size: 16pt;background: %1;color: %2").arg(Radio::convert_dark("#ffff96",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
        }
    }
...
void MainWindow::setAutoSeqButtonStyle(bool checked) {
  if(checked) {
    if(m_singleshot) { ui->AutoSeqButton->setStyleSheet(QString("QPushButton {color: %1;background: %2;border-style: solid;border-width: 1px;border-radius: 5px;border-color: %3;min-width: 4em;padding: 3px}").arg(Radio::convert_dark("#0000ff",m_useDarkStyle),Radio::convert_dark("#00ff00",m_useDarkStyle),Radio::convert_dark("#000000",m_useDarkStyle))); }
    ...
    if(m_singleshot) {
      if(m_mode.startsWith("FT")) { ui->AutoSeqButton->setStyleSheet(QString("QPushButton {color: %1;background: %2;border-style: solid;border-width: 1px;border-color: %3;min-width: 4em;padding: 3px}").arg(Radio::convert_dark("#0000ff",m_useDarkStyle),Radio::convert_dark("#ffbbbb",m_useDarkStyle),Radio::convert_dark("#808080",m_useDarkStyle))); }
      ...
      if(m_mode.startsWith("FT")) { ui->AutoSeqButton->setStyleSheet(QString("QPushButton {color: %1;background: %2;border-style: solid;border-width: 1px;border-color: %3;min-width: 4em;padding: 3px}").arg(Radio::convert_dark("#000000",m_useDarkStyle),Radio::convert_dark("#ffbbbb",m_useDarkStyle),Radio::convert_dark("#808080",m_useDarkStyle))); }
...
{
  if(!(m_mode.startsWith ("WSPR") or m_houndMode)) {
	if(m_txFirst) {
	  if(m_mode.startsWith("FT")) {
...
//  printf("last band %s curband %s band %s freq %lld\n",m_lastBand.toStdString().c_str(),ui->bandComboBox->currentText().toStdString().c_str(),band_name.toStdString().c_str(),dial_frequency);
  if(m_lastBand != band_name && ui->bandComboBox->currentText() != band_name) {
    ...
    band_changed(true);  // update state and color of the band buttons when dialling the VFO
  }
  ...
  if (valid) ui->labDialFreq->setStyleSheet(QString("QLabel {font-family: MS Shell Dlg 2;font-size: 16pt;background: %1;color: %2;}").arg(Radio::convert_dark("#e1e1e1",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
  else ui->labDialFreq->setStyleSheet(QString("QLabel {font-family: MS Shell Dlg 2;font-size: 16pt;background: %1;color: %2;}").arg(Radio::convert_dark("#ff0000",m_useDarkStyle),Radio::convert_dark("#0000ff",m_useDarkStyle)));
...
/*
  if (m_useDarkStyle) {
      ...
      ui->tabWidget->setMaximumHeight(215);
  }
*/
  ui->pbTxLock->setChecked(m_lockTxFreq);
  on_pbTxLock_clicked(m_lockTxFreq);
...
//  ui->txrb6->setStyleSheet(QString("QRadioButton::indicator:checked:disabled{background: %1;width: 6px;height: 6px;border-radius: 3px;margin-left: 3px}").arg(Radio::convert_dark("#222222",m_useDarkStyle)));
  ...
  ui->ft8Button->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
  ui->ft4Button->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
  ui->jtButton->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
...
void MainWindow::on_actionJTDX_improved_Home_Page_triggered() { m_manual.display_html_url (QUrl {"https://jtdx-improved.sourceforge.io/"}, ""); }
void MainWindow::on_actionThe_additional_features_of_jtdx_improved_triggered() { m_manual.display_html_url (QUrl {"https://jtdx-improved.sourceforge.io/The_additional_features_of_jtdx_improved.pdf"}, ""); }
...
// Don't allow Hound frequency control in common FT8 bands if VFO Split mode is switched off
  ...
  if(m_houndMode) {
    ui->HoundButton->setStyleSheet(QString("QPushButton {color: %1;background: %2;border-style: solid;border-width: 1px;border-radius: 5px;border-color: %3;min-width: 4em;padding: 3px}").arg(Radio::convert_dark("#000000",m_useDarkStyle),Radio::convert_dark("#00ff00",m_useDarkStyle),Radio::convert_dark("#000000",m_useDarkStyle)));
    ...
    ui->HoundButton->setStyleSheet(QString("QPushButton {color: %1;background: %2;border-style: solid;border-width: 1px;border-color: %3;min-width: 4em;padding: 3px}").arg(Radio::convert_dark("#000000",m_useDarkStyle),Radio::convert_dark("#e1e1e1",m_useDarkStyle),Radio::convert_dark("#adadad",m_useDarkStyle)));
...
//      DecodedText decodedtext {"161545  -4  0.1 1939 & CQ RT9K/4    ",this};
      ...
      // show distance and azimuth
      QString distance;
      if ((m_config.showDistance() || m_config.showAzimuth()) && grid != "") {
          double utch=0.0;
          int nAz,nEl,nDmiles,nDkm,nHotAz,nHotABetter;
          if (grid != "" && !m_config.my_grid ().isEmpty())
      ...
      if (m_config.highlightDXCall () && (m_hisCall!="") && ((decodedtext.string().contains(QRegularExpression {"(\\w+) " + m_hisCall}))
          ...
          if (m_config.highlightDXCall ()) play_DXcall = true;
          ...
          QTimer::singleShot (4000, [=] {                      // repeated highlighting to override JTAlert
              ui->decodedTextBrowser->highlight_callsign(m_hisCall, QColor(255,0,0), QColor(255,255,255), true);
              });
      }
      if (m_config.highlightDXGrid () && (m_hisGrid!="") && (decodedtext.string().contains(m_hisGrid)))  {
          ui->decodedTextBrowser->highlight_callsign(m_hisGrid, QColor(0,0,255), QColor(255,255,255), true);
          if (m_config.highlightDXGrid ()) play_DXcall = true;
      }
          QTimer::singleShot (100, [=] {
              if ((m_config.alertOnDXCall ()) && (play_DXcall) && (m_hisCall!="")) {
#ifdef WIN32
      ...
      if(m_okToPost and m_config.spot_to_psk_reporter () and stdMsg and !m_diskData) {
        ...
        if(gridOK(grid) && !gridRR73(grid) && !decodedtext.isHint() && !decodedtext.isWrong()
           && !(decodedtext.string().contains(m_baseCall) && decodedtext.string().contains(m_config.my_grid().left(4))))  // no self-spotting
              {
...
//            printf("DXCall log_data %s %s %s\n",m_hisCall.toStdString().c_str(),grid.toStdString().c_str(),m_name.toStdString().c_str());
      ...
      m_bHisCallStd=stdCall(m_hisCall);
      statusChanged();
      ui->decodedTextBrowser->DXCall(m_hisCall);
  }
}
...
void MainWindow::on_dxGridEntry_textChanged(const QString &t) //dxGrid changed
{
  ...
  if (t != m_hisGrid) { ui->dxGridEntry->setText(m_hisGrid); ui->dxGridEntry->setCursorPosition (pos); }
        ...
        ui->decodedTextBrowser->DXGrid(m_hisGrid);
  }
  if(!ui->spotLineEdit->text().isEmpty() && ui->spotLineEdit->text().contains("#")) on_spotLineEdit_textChanged(ui->spotLineEdit->text());
}
...
void MainWindow::on_actionJT9_triggered()
{
  ...
  ui->jtButton->setChecked(false);
  ui->ft8Button->setChecked(false);
  ui->ft4Button->setChecked(false);
}
...
//    Switch off Hound mode if coming to the regular FT8 band
  ...
  QTimer::singleShot (75, [=] {                       // set state and colors of the band buttons
      if(m_config.bands()->find (m_freqNominal)=="160m") {
          ui->pb160->setChecked(true);
          ui->pb160->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
      } else {
          ui->pb160->setChecked(false);
      }
      if(m_config.bands()->find (m_freqNominal)=="80m") {
          ui->pb80->setChecked(true);
          ui->pb80->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
      } else {
          ui->pb80->setChecked(false);
      }
      if(m_config.bands()->find (m_freqNominal)=="60m") {
          ui->pb60->setChecked(true);
          ui->pb60->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
      } else {
      ...
      if(m_config.bands()->find (m_freqNominal)=="2m") {
          ui->pb2->setChecked(true);
          ui->pb2->setStyleSheet(QString("QPushButton:checked{background: %1}").arg(Radio::convert_dark("#00ff00",m_useDarkStyle)));
      } else {
          ui->pb2->setChecked(false);
      }
  });
...
void MainWindow::pskSetLocal ()
{
  ...
  psk_Reporter->setLocalStation(m_config.my_callsign (), m_config.my_grid (), antenna_description, QString {"JTDX v" + version() + (" i")}.simplified ());    // UR
}
...
void MainWindow::on_jtButton_clicked()
{
    ui->actionEnable_hound_mode->setChecked(false);
    on_actionJT9_JT65_triggered();
}
...
void MainWindow::bandHoppingTimer()
{
    ...
    case 0:
            ...
            return;
    case 1:
            psk_Reporter->sendReport();      // spot late decodes before changing band
            bandHopping();
            startIndex = 0;
            return;
     }
...
void MainWindow::bandHopping()
{
    ...
    case 13:
        ...
        Q_FALLTHROUGH();
    case 14:
        if (ui->cb40mJT->isChecked()) {
            on_actionJT9_JT65_triggered();
            m_freqNominal = 7076000;
            m_freqTxNominal = m_freqNominal;
            setRig ();
            ui->pbBandHopping->setChecked(true);
            monitor (true);
        ...
        Q_FALLTHROUGH();
    case 15:
        if (ui->cb20mJT->isChecked()) {
            on_actionJT9_JT65_triggered();
            m_freqNominal = 14076000;
            m_freqTxNominal = m_freqNominal;
            setRig ();
            ui->pbBandHopping->setChecked(true);
            monitor (true);
        ...
        Q_FALLTHROUGH();
    case 16:
        if (ui->cb15mJT->isChecked()) {
            on_actionJT9_JT65_triggered();
            m_freqNominal = 21076000;
            m_freqTxNominal = m_freqNominal;
            setRig ();
            ui->pbBandHopping->setChecked(true);
            monitor (true);
        ...
        Q_FALLTHROUGH();
    case 17:
        if (ui->cb10mJT->isChecked()) {
            on_actionJT9_JT65_triggered();
            m_freqNominal = 28076000;
            m_freqTxNominal = m_freqNominal;
            setRig ();
            ui->pbBandHopping->setChecked(true);
            monitor (true);
...
{
    if(!checked) {
        ui->pb160->setVisible(!checked);
        ui->pb80->setVisible(!checked);
        ui->pb60->setVisible(!checked);
...
{
    if(m_mode=="FT8") m_freqNominal = 1840000;
    if(m_mode=="FT4") m_freqNominal = 1840000;
    if(m_mode=="JT9+JT65" or m_mode=="JT65") m_freqNominal = 1838000;
    if(m_mode=="JT9") m_freqNominal = 1839000;
    if(m_mode=="T10") m_freqNominal = 1839500;
    if(m_mode=="WSPR-2") m_freqNominal = 1836600;
    m_freqTxNominal = m_freqNominal;
    setRig ();
...
{
    if(m_mode=="FT8") m_freqNominal = 3573000;
    if(m_mode=="FT4") m_freqNominal = 3575000;
    if(m_mode=="JT9+JT65" or m_mode=="JT65") m_freqNominal = 3570000;
    if(m_mode=="JT9") m_freqNominal = 3572000;
    if(m_mode=="T10") m_freqNominal = 3572500;
    if(m_mode=="WSPR-2") m_freqNominal = 3568600;
    m_freqTxNominal = m_freqNominal;
    setRig ();
    band_changed (m_freqNominal);
}
...
{
    if(m_mode=="FT8") m_freqNominal = 5357000;
    if(m_mode=="FT4") m_freqNominal = 5357000;
    if(m_mode=="JT9+JT65" or m_mode=="JT65") m_freqNominal = 5357000;
    if(m_mode=="JT9") m_freqNominal = 5357000;
    if(m_mode=="T10") m_freqNominal = 5357500;
    if(m_mode=="WSPR-2") m_freqNominal = 5357000;
    m_freqTxNominal = m_freqNominal;
    setRig ();
    band_changed (m_freqNominal);
}
...
{
    if(m_mode=="FT8") m_freqNominal = 144174000;
    if(m_mode=="FT4") m_freqNominal = 144170000;
    if(m_mode=="JT9+JT65" or m_mode=="JT65") m_freqNominal = 144120000;
    if(m_mode=="JT9") m_freqNominal = 144122000;
    if(m_mode=="T10") m_freqNominal = 144176000;
    if(m_mode=="WSPR-2") m_freqNominal = 144489000;
    m_freqTxNominal = m_freqNominal;
    setRig ();
    band_changed (m_freqNominal);
}
