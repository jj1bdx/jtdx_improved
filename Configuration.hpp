...
public:
  ...
  bool alertOnMyCall () const;
  bool alertOnNewCQZ () const;
  bool alertOnNewITUZ () const;
  bool alertOnNewDXCC () const;
  bool alertOnNewGrid () const;
  bool alertOnNewPx () const;
  bool alertOnNewCQZOB () const;
  bool alertOnNewITUZOB () const;
  bool alertOnNewDXCCOB () const;
  bool alertOnNewGridOB () const;
  bool alertOnNewPxOB () const;
  bool alertOnDXCall () const;
  bool highlightDXCall () const;
  bool highlightDXGrid () const;
